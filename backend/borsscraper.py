...
def scrape_osebx_html(quotes: str, returns: str, verbose: bool = False):
    '''
...
if __name__ == '__main__':
    df = scrape_osebx_html(cng.QUOTES_HTML_FILE, cng.RETURNS_HTML_FILE, verbose=True)
    df.to_csv(cng.BORS_CSV_FILE, index=False)
