...
class TickerBase():
    ...
    def _get_fundamentals(self, kind=None, proxy=None):
        ...
        # TODO: HOLDERS FUCKING SHIT WHATT THE FUCK IS THIS
        # THIS SHIT CODE CRASHES IN A BAJILLION DIFFERENT WAYS
        # EVEN WITH THE FUCKNIG TRY EXCCEPT WTF
        ...
        try:
            ...
            print(f'Warning: {e}, will not add "holders" feature whatever the fuck it is')
            holders = []

        # TODO: HOTFIX SHIT HERE!
        # Crashes for some stuff since holders array won't always be len 2
        # therefore make stupid if test as you can see
        ...
        # sustainability
        # TODO: This shit crashes for some fucking reason, what the fuck is esg anyways
        try:
            d = {}
            ...
            print(f'Warning: {e}, esg shit is fucked up lol')
        ...
        # TODO: This shit crashes since there is no point where 'regularMarketOpen' gets defined as key
        # try:
        #     self._info['regularMarketPrice'] = self._info['regularMarketOpen']
        # except KeyError as e:
        #     print(f'Warning: {e}, will not add regularMarketPrice because code is shit')
